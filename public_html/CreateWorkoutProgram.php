...
<body>
    ...
    <!--<div id=CreateWorkoutPage>
        <div id="ExistingOrNew">
            <button onclick="" id="ExistingButton" type="button" class="btn btn-primary">Existing Workout</button>
            <button onclick="loadNewWorkout()" id="NewButton" type="button" class="btn btn-success">Create New Workout</button>
        </div>
        <div id="CreateExisting" hidden="True">
            testing
        </div>
        <div id="CreateNew" hidden="True">
            testing 2
        </div>
    </div>-->
</body>
